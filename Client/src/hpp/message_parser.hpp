...
private:
    ...
    static std::pair<message_parser::idsvec, message_parser::strvec> extract_args(chat_message const &msg, size_t start, int idc, int strc);

    static message_parser::idsvec extract_ids(chat_message const &msg, size_t start, int idc);

    static message_parser::strvec extract_strs(chat_message const &msg, size_t start, int strc);
